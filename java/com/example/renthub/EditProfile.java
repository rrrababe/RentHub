...
public class EditProfile extends AppCompatActivity {
    ...
    private EditText name,username,email,address,contactNo;
    ...
    private void updateProfile() {
        ...
        Toast.makeText(EditProfile.this, "Profile has been updated successfully.", Toast.LENGTH_SHORT).show();
        finish();
    ...
    private void userinfoDisplay(CircleImageView pro_pic, EditText name, EditText email, EditText username, EditText address, EditText contactNo) {
        ...
        databaseReference.child(auth.getCurrentUser().getUid()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.hasChild("image")) {
                    ...
                    Glide.with(EditProfile.this).load(image).into(pro_pic1);
...
public class EditProfile extends AppCompatActivity {
    ...
    private void userinfoDisplay(CircleImageView pro_pic, EditText name, EditText email, EditText username, EditText address, EditText contactNo) {
        FirebaseDatabase.getInstance().getReference().child("Users").child(cur_user.getUid()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    if(snapshot.child("image").exists() && snapshot.child("Address").exists() && snapshot.child("ContactNo").exists()){
